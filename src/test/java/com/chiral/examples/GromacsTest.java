...
public class GromacsTest 
{
    ...
    public void testGromacs()
    {
        ...
        try {
            ...
            JobManager jm = new JobManager(client, simulationId, localDirectory);
            ...
            // Job - npt mdrun
            {
                ...
                System.out.println("NPT mdrun ... DONE");
            }
            ...
            // Job - production mdrun
            {
                ...
                System.out.println("Production mdrun ... DONE");
            }
            // Job - trjconv 
            {
